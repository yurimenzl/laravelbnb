<template>
  <div>
    <success v-if="success">You've left a review! Thank tou very much!</success>
      ...
      <div :class="[{ 'col-md-8': twoColumns },{ 'col-md-12': oneColumn }]">
        ...
        <div v-else>
          <div v-if="alreadyReviewed">
            <h3>You've left a review for this booking!</h3>
          </div>
          <div v-else>
            ...
            <div class="form-group">
              <label for="content" class="text-mute">Describe your experience with</label>
              <textarea
                name="content"
                cols="30"
                rows="10"
